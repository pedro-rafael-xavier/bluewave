...
if($form_1){
  $id = $_GET["id"];
  $h = get_home();
  $form_2 = !empty($_GET["title"]) && !empty($_GET["subtitle"]) && !empty($_GET["text"]);
  if($form_2){
    $title = $_GET["title"];
    $subtitle = $_GET["subtitle"];
    $text = $_GET["text"];
    edit_home($title, $subtitle, $text);
      ...
      <div class="row admin-box px-0 mt-4">
        <div class="col-12 mx-auto px-0">
          <div class="admin-box-header d-flex justify-content-between align-items-center px-4">
            <div class="admin-box-title fs-1">Edit Home Page</div>
          </div>
                ...
                <form action="">
                  ...
                  <div class="container card-box p-3 my-2">
                    <div class="row mx-auto">
                      <div class="col-6">
                        <label for="edit_home_title"><i class="bi bi-pencil-fill"></i>Edit title:</label>
                        <br>
                        <input type="text" name="title" id="edit_home_title" placeholder="Title" autofocus value="<?= $h["title"] ?>">
                      </div>
                      <div class="col-6">
                        <label for="edit_home_subtitle"><i class="bi bi-pencil-fill"></i>Edit subtitle:</label>
                        <br>
                        <input type="text" name="subtitle" id="edit_home_subtitle" placeholder="Subtitle" value="<?= $h["subtitle"] ?>">
                      </div>
                    </div>
                    <div class="row mx-auto mt-4">
                      <div class="col-12">
                        <label for="text"><i class="bi bi-file-text-fill"></i>Edit text</label>
                        <textarea name="text" id="text" placeholder="Write your text here" class="tinymce"><?= $h["text"] ?></textarea>
                      </div>
                    </div>
