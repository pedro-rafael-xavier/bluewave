      ...
      <div class="row admin-box px-0 mt-4">
        <div class="col-12 mx-auto px-0">
          <div class="admin-box-header d-flex justify-content-between align-items-center px-4">
            <div class="admin-box-title fs-1">Create new About Page</div>
          </div>
                ...
                <form action="">
                  ...
                  <div class="container card-box p-3 my-2">
                    <div class="row mx-auto">
                      <div class="col-12">
                        <label for="home_title_new"><i class="bi bi-pencil-fill"></i>Title:</label>
                        <br>
                        <input type="text" name="title" id="home_title_new" placeholder="Title" required autofocus>
                      </div>
                    </div>
                    ...
                    <div class="row mx-auto mt-3">
                      <div class="col-12">
                        ...
                        <button class="btn botao-voltar"><i class="bi bi-arrow-return-left"></i><a href="about.php">Return</a></button>
                      </div>
                    </div>
                  </div>
                </form>
