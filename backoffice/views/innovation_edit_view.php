...
if($form_1){
  $id = $_GET["id"];
  $si = get_specific_innovations($id);
  $form_2 = !empty($_GET["title"]) && !empty($_GET["text"]);
  if($form_2){
    $title = $_GET["title"];
    $text = $_GET["text"];
    edit_innovation($title, $text, $id);
      ...
      <div class="row admin-box px-0 mt-4">
        <div class="col-12 mx-auto px-0">
          <div class="admin-box-header d-flex justify-content-between align-items-center px-4">
            <div class="admin-box-title fs-1">Edit Innovation and Technology</div>
            <a href="innovation_create.php" class="create-btn"><i class="bi bi-pencil-square"></i>Create New Innovation and Technology Page</a>
          </div>
                ...
                <form action="">
                  ...
                  <div class="container card-box p-3 my-2">
                    <div class="row mx-auto">
                      <div class="col-12">
                        <label for="edit_innovation_title"><i class="bi bi-pencil-fill"></i>Edit title:</label>
                        <br>
                        <input type="text" name="title" id="edit_innovation_title" placeholder="Title" autofocus value="<?= $si["title"] ?>">
                      </div>
                    </div>
                    <div class="row mx-auto mt-4">
                      <div class="col-12">
                        <label for="text"><i class="bi bi-file-text-fill"></i>Edit text</label>
                        <textarea name="text" id="text" placeholder="Write your text here" class="tinymce"><?= $si["text"] ?></textarea>
                      </div>
                    </div>
