...
if($form){
  ...
  $image = $_GET["image"];
  create_highlights($title, $text, $show_in_home, $image, $date);
      ...
      <div class="row admin-box px-0 mt-4">
        <div class="col-12 mx-auto px-0">
          <div class="admin-box-header d-flex justify-content-between align-items-center px-4">
            <div class="admin-box-title fs-1">Create Highlight</div>
          </div>
                ...
                <form action="">
                  ...
                  <div class="container card-box p-3 my-2">
                    <div class="row mx-auto">
                      <div class="col-6">
                        <label for="name_new_highlight"><i class="bi bi-pencil-fill"></i>Highlight name:</label>
                        <br>
                        <input type="text" name="title" id="name_new_highlight" placeholder="Title" required autofocus>
                      </div>
                      <div class="col-6">
                        <label for="date_new_highlight"><i class="bi bi-calendar-event"></i>Highlight date:</label>
                        <br>
                        <input type="date" id="date_new_highlight" name="date" placeholder="Date" required>
                      </div>
                    </div>
                    <div class="row mx-auto mt-3">
                      <div class="col-12">
                        <label for="image_new_highlight"><i class="bi bi-link"></i>Insert the image URL:</label>
                        <br>
                        <textarea name="image" id="image_new_highlight" placeholder="Image" required></textarea>
                      </div>
                    </div>
                    <div class="row mx-auto mt-3">
                      <div class="col-6">
