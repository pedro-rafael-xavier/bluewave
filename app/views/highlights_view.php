...
$highlights = get_highlights_page($page);
          ...
          <div class="container-fluid">
                  ...
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-12 px-0">
                        <img src="<?= $h["image"] ?>" alt="<?= $h["image"] ?>" class="w-100" height="300">
                      </div>
                    </div>
                    <div class="row">
            ...
            <div class="row mt-5">
              <div class="col-12 px-0 paginacao d-flex justify-content-center align-items-center gap-2">
                <a href="highlights.php?page=<?= $page-1 ?>" class="voltar"></a>

                <?php for($i=1; $i<=$total_pages; $i++): ?>

                  <a href="highlights.php?page=<?= $i ?>" class="numero <?= ($page == $i) ? "active" : "" ?>"><?= $i ?></a>

                <?php endfor ?>

                <a href="highlights.php?page=<?= $page+1 ?>" class="avancar"></a>
              </div>
            </div>
        ...
        <?php foreach($highlights as $h): ?>
          ...
          <div class="col-12 col-sm-8 mx-0 mx-sm-auto caixa">
            <div class="container-fluid px-0">
              <div class="row">
                <div class="col-12 px-0">
                  <img src="<?= $h["image"] ?>" alt="<?= $h["image"] ?>" class="w-100">
                </div>
              </div>
              <div class="row">
                <div class="col-11 mx-auto caixa-branca p-4">
